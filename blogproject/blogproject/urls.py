...
urlpatterns = [
    ...
    path('createPastime/', views.createPastime, name="createPastime"),
    path('pastime/', views.pastime, name="pastime"),
    
    path('createPlace/', views.createPlace, name="createPlace"),
    ...
    path('post/', views.createBlog, name="creatBlog"),
    path('ckeditor/', include('ckeditor_uploader.urls')),

    path('createBlog/', views.createBlog, name='createBlog'),
    path('postmain/', views.postmain, name='postmain'),
